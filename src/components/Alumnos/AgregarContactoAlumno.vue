...
export default {
  ...
  methods: {
    async PostNewContactoAlumno() {
      ...
      .then(res=>{this.$router.push({ name: 'AlumnoCompleto', params: {SuccessCountDownCreationProp: 4 }})})
      .catch(err=>{this.$router.push({ name: 'AlumnoCompleto', params: {ErrorCountDownCreationProp: 6 }})})
    }
  }
};
</script>
